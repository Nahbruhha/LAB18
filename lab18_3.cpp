 ...
 while(getline(course_file,textline)){
  if(state == 1){
   ...
   if(textline == "> Students"){
    ...
    allcourses.back().lecture_list.push_back(textline); //[Missing Code 3] Append (push_back) textline to lecture_list[] of the recently added course in allcourses[];
   ...
   if(textline == "---------------------------------------"){
    ...
    allcourses.back().student_list.push_back(p); //[Missing Code 5] Append (push_back) p to student_list of the recently added course in allcourses[];
